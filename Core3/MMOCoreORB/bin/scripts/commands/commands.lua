...
includeFile("commands/Admin/ShutdownServerCommand.lua")
-- Include other command files as needed
-- includeFile("commands/SomeOtherCommand.lua")

-- Register commands
function registerCommands()
    -- Register the shutdown server command
    registerCommand(ShutdownServerCommand.name, ShutdownServerCommand)
    
    -- Register other commands as needed
    -- registerCommand(SomeOtherCommand.name, SomeOtherCommand)
end

-- Call the function to register all commands
registerCommands()
